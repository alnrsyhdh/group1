...
public class ViewShoes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShoesData[] shoesData = new ShoesData[]{
                ...
                new ShoesData("Summer Dior","matte black","almost flat","6","RM 70 PER DAY",R.drawable.kasut1),
                new ShoesData("Winter Chanel","shiny black","almost flat","7","RM 80 PER DAY",R.drawable.kasut2),
                new ShoesData("Fall Yves Saint Laurent","velvet black","small heels","8","RM 70 PER DAY",R.drawable.kasut3),
