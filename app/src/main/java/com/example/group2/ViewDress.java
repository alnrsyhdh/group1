...
public class ViewDress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DressData[] dressData = new DressData[]{
                ...
                new DressData("Classic Wavy","Milky White","semi ball gown with deep v-cut from neck to chest",
                        "XL","RM 450 PER DAY",R.drawable.wedding2),
                ...
                new DressData("Bright Angel ","Pearly White","fit and flare with deep v-neck","L",
                        "RM 350 PER DAY",R.drawable.wedding3),
