...
public class PrintReceipt extends AppCompatActivity {
    ...
    private TextView disDress, disName, disIc, disPhone, disAdd, disDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDressRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                disDress.setText(String.format("Dress Name: %s", rentalDressData.getCustDress()));
                ...
                disAdd.setText(String.format("Address: %s", rentalDressData.getAdd()));
